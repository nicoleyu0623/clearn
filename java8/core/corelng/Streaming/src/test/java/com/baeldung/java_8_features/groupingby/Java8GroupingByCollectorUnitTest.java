...
public class Java8GroupingByCollectorUnitTest {
    ...
    public void givenAListOfPosts_whenGroupedByComplexMapKeyType_thenGetAMapBetweenTupleAndList()
    {
        ...
        //asserts
        assertThat(postsPerTypeAuthor.get(new Tuple(BlogPostType.GUIDE, "Author 1")).size(),
                is(1));
        assertThat(postsPerTypeAuthor.get(new Tuple(BlogPostType.NEWS, "Author 2")).size(),
                is(2));
    }
