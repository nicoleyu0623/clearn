...
public class StreamingRsvpsDStream {
    ...
    private static final int BATCH_DURATION_INTERVAL_MS = 3000; // 5 secs batch intval

    private static final Map<String, Object> KAFKA_CONSUMER_PROPERTIES;    
    
    private static final String KAFKA_BROKERS = "localhost:9092";
    private static final String KAFKA_OFFSET_RESET_TYPE = "latest"; //read from latest offset
